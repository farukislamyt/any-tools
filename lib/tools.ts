...
export const tools: Tool[] = [
  ...
  { slug: "metal-weight", name: "Metal Weight Calculator", description: "Calculate steel and metal weight from custom dimensions and material density.", category: "Metallurgy", icon: "scale", href: "/tools/metal-weight" },
];

export const categories = ["All", "Calculators", "Metallurgy"];
